<%@ Page Title="Branch" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="frm_branch.aspx.cs" Inherits="Foods.frm_branch" %>
...
<%--    <asp:UpdatePanel  ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
            ...
            <ul class="breadcrumb">
				...
				<li><a href="frm_branch.aspx">Branch</a></li>
			</ul>
           <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon align-justify"></i><span class="break"></span>Branch</h2>
						<div class="box-icon">
						</div>
					</div>
					<div class="box-content">
                        <asp:Label ID="lblBranch" runat="server" style="color:red;"></asp:Label>
                        <div class="span8">
                        <div class="control-group  span12">
							<label class="control-label span2" for="appendedInputButton">Search</label>
							<div class="controls">
                                 <div class="input-append span6">
                                       <asp:TextBox ID="TBSearchBranch" runat="server" size="16" /><asp:Button ID="SeacrhBtn"  runat="server" CssClass="btn" Text="GO!" OnClick="SeacrhBtn_Click" />
    						    </div>
                        ...
                        <div class="row-fluid sortable">		
	                         <div class="box span12">
				                <div class="box-header" data-original-title>
					                <h2><i class="halflings-icon align-justify"></i><span class="break"></span>Branch List</h2>
					                <div class="box-icon">
				                ...
				                <div class="box-content">
                                    <asp:GridView ID="GVBranch" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="5" DataKeyNames="CompanyId,BranchId" CssClass="table table-striped table-bordered" OnRowCommand="GVfrm_branchRowCommand" OnPageIndexChanging="GVfrm_branchPageIndexChanging" OnRowDeleting="GVfrm_branchRowDeleting">
                                        <Columns>
                                            <asp:BoundField DataField="BranchId" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="BranchId" />
				...
				<div class="modal-content">
					...
					<div class="modal-body">
					 <table class="table span12">
                         <tr>
                            ...
                            <td class="span8">
                                <asp:Label ID="lbl_BrnID" runat="server" Visible="false"></asp:Label>
                                <asp:DropDownList ID="ddl_comp" runat="server"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="span3">
                                <asp:Label ID="lbl_Branch" runat="server">Branch Name</asp:Label>
                            </td>
                            <td class="span8">
                                <asp:TextBox ID="TBBranch" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="span3">
				  ...
				  <!-- dialog buttons -->
					<div class="modal-footer">
                            <asp:Button ID="BtnCreateBranch" runat="server" CssClass="btn btn-success" Text="Create" OnClick="BtnCreateBranch_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="BtnCancelBranch" runat="server" CssClass="btn btn-danger" Text="Cancel"  OnClick="BtnCancelBranch_Click" OnClientClick="show();" />
    ...
    <%--<asp:Button ID="BtnCancelBranch" runat="server" CssClass="btn btn-danger" Text="Cancel"  OnClick="BtnCancelfrm_branchClick" OnClientClick="show();" />--%>						
</asp:Content>
