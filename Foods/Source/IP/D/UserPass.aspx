<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="UserPass.aspx.cs" Inherits="Foods.UserPass" %>
...
<%--    <asp:UpdatePanel  ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
            ...
            <ul class="breadcrumb">
				...
				<li><a href="UserPass.aspx">Change Password</a></li>
			</ul>
    ...
    <%--<asp:Button ID="BtnCancelCategory" runat="server" CssClass="btn btn-danger" Text="Cancel"  OnClick="BtnCancelUserPassClick" OnClientClick="show();" />--%>						
</asp:Content>
