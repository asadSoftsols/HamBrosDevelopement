<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
     CodeBehind="frm_Area.aspx.cs" Inherits="Foods.frm_Area" %>
    ...
    <%--    <asp:UpdatePanel  ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
            ...
            <ul class="breadcrumb">
				...
				<li><a href="frm_Area.aspx">Area</a></li>
			</ul>
           <div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon align-justify"></i><span class="break"></span>Area</h2>
						<div class="box-icon">
						</div>
					</div>
					<div class="box-content">
                        <asp:Label ID="lblArea" runat="server" style="color:red;"></asp:Label>
                        <div class="span8">
                        <div class="control-group  span12">
							<label class="control-label span2" for="appendedInputButton">Search</label>
							<div class="controls">
                                 <div class="input-append span6">
                                       <asp:TextBox ID="TBSearchArea" runat="server" size="16" /><asp:Button ID="SeacrhBtn"  runat="server" CssClass="btn" Text="GO!" OnClick="SeacrhBtn_Click" />
    						    </div>
                        ...
                        <div class="row-fluid sortable">		
	                         <div class="box span12">
				                <div class="box-header" data-original-title>
					                <h2><i class="halflings-icon align-justify"></i><span class="break"></span>Area List</h2>
					                <div class="box-icon">
				                ...
				                <div class="box-content">
                                    <asp:GridView ID="GVArea" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="5" DataKeyNames="areaid" CssClass="table table-striped table-bordered" OnRowCommand="GVArea_RowCommand" OnPageIndexChanging="GVArea_PageIndexChanging" OnRowDeleting="GVArea_RowDeleting">
                                        <Columns>
				...
				<div class="modal-content">
                    ...
                    <tr>
                        ...
                        <td class="span8">
                            ...
                            <asp:Label ID="v_area" runat="server" Font-Bold="true" ForeColor="Red" Text=""></asp:Label>
                        </td>
                    </tr>
                </table>
					</div>
				  <!-- dialog buttons -->
					<div class="modal-footer">
                            <asp:Button ID="BtnCreateArea" runat="server" CssClass="btn btn-success" Text="Create" OnClick="BtnCreateArea_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="BtnCancelArea" runat="server" CssClass="btn btn-danger" Text="Cancel"  OnClick="BtnCancelArea_Click" OnClientClick="show();" />
