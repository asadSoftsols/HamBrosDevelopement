<%@ Page Title="Bank Payments Voucher" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
     CodeBehind="frm_BPV.aspx.cs" Inherits="Foods.frm_BPV" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <li><a href="frm_BPV.aspx">Bank Payment Voucher</a></li>
    </ul>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <div class="box  span12">
        <div class="box-header" data-original-title>
            <h3><i class="halflings-icon edit"></i><span class="break"></span> Bank Payment Voucher </h3>
        </div>
        <div class="box-content">
                        ...
                        <div class="box-content">                                 
                            <div class="span1">
                                <div class="control-group">
                                    <label class="control-label" for="TBSrhBPV">Search</label>
                                </div>
                            </div>
                            <div class="span10">
                                <div class="controls">
                                    <div class="input-append">
                                        <asp:TextBox runat="server" class="span12" ID="TBSrhBPV" OnTextChanged="TBSrhBPV_TextChanged" AutoPostBack="true" ></asp:TextBox><asp:LinkButton runat="server" ID="LnkBtn_MDN" CssClass="add-on" ><i class="icon-search"></i></asp:LinkButton>
                                    </div>
                                </div>
                            </div>
                            <div class="span12">
                                <div class="controls">
                                    <div class="scrollit">
                                        <asp:GridView ID="GVScrhBPV" runat="server" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found!"  class="table table-striped table-bordered" AllowPaging="True" PageSize="4" AutoGenerateColumns="False" DataKeyNames="mjv_id" OnRowDeleting="GVScrhBPV_RowDeleting" OnSelectedIndexChanging="GVScrhBPV_SelectedIndexChanging">
                                            <Columns>
            ...
            <div class="row-fluid">	
                <div class="span12">
                    <div class="span5">
                        <h1><span style="color:black;"> Bank Payment Voucher</span></h1>                                    
                    </div>
                    <div class="span2"></div>
                        <div class="span2">
                            <div class="box span12">
                                ...
                                <div class="box-content">
                                    <asp:TextBox runat="server" class="span10 datepicker" ID="TBBPVDat" ></asp:TextBox>
                                </div>
                            </div>
                        </div>                               
                    <div  class="span3">
                        <div class="box  span12">
                            ...
                            <div class="box-content">
                                <asp:Label runat="server" class="span12" ID="lbl_BPVSNo" ></asp:Label>
                            </div>
                        </div>
                    </div>
                    <div class="row-fluid">	
                                ...
                                <div class="span12">
                                    <div class="control-group">    
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:TextBox runat="server" class="span12" ID="TBChqNo" placeholder="Chq No..." ></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                               <div class="span12">
                                    <div class="control-group">    
                                        ...
                                        <div class="controls">
                                            <%--<asp:DropDownList ID="DDLCshBnk" runat="server" data-rel="chosen" CssClass="span12"></asp:DropDownList>--%>
                                            <asp:TextBox runat="server" ID="TBChqDat"  class="span10 datepicker" ></asp:TextBox>
                                        </div>
                                    </div>
                                </div>  
                                <div class="span12">
                                ...
                                <div class="span12">
                                    <div class="control-group">
                                        Payment to
                                        <div class="controls">
                                            <asp:DropDownList id="DDL_Payto" runat="server" data-rel="chosen" CssClass="span12"></asp:DropDownList>                                           
                                        </div>
                                    </div>
                                </div>
                                <div class="span12">
                                ...
                                <div class="span3">
                                    <div class="control-group">
                                        <label style="color:black" for="TBTotal" >Chq/Cash Amount</label>
                                        <div class="controls">
                                            <asp:TextBox runat="server" class="span12" ID="TBTotal" Text="0.00"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RFVTtl" ValidationGroup="VGBPV" runat="server" ErrorMessage="Total Can not be Null" ControlToValidate="TBTotal"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                <div class="span3">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RFVITAX" ValidationGroup="VGBPV" runat="server" ErrorMessage="ITax % Can not be Null" ControlToValidate="TBITAX" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                <div class="span3">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RFVGTtl" ValidationGroup="VGBPV" runat="server" ErrorMessage="ITax Amount Can not be Null" ControlToValidate="TBItaxamt" ForeColor="Red"></asp:RequiredFieldValidator>                                        
                                        </div>
                                    </div>
                                </div>
                                <div class="span12">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <asp:RequiredFieldValidator ID="RFVTtlAmt" ValidationGroup="VGBPV" runat="server" ErrorMessage="Total Amount Can not be Null" ControlToValidate="TBttlAmt" ForeColor="Red"></asp:RequiredFieldValidator>
                                        </div>
                                    </div>
                                </div>
                                <div class="span12">
