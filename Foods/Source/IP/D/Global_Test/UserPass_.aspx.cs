...
namespace Foods
{
    public partial class UserPass_ : System.Web.UI.Page
    {
        ...
        public void updatepassword()
        {
            ...
            {
                using (SqlCommand cmd = new SqlCommand("update Users set Password = @Password where Username = '" + DDL_Emp.SelectedValue.Trim() + "'"))
                {
