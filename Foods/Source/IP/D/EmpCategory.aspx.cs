...
namespace Foods
{
    public partial class EmpCategory : System.Web.UI.Page
    {
        ...
        protected void GVEmpCategoryRowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
        ...
        private int Save()
        {
            ...
            query = " INSERT INTO [dbo].[tbl_producttype] " +
                           " ([empCat_nam],[CreateBy],[CreatedAt],[IsActive]) VALUES('"+ TBCategoryType.Text.Trim() + "','"  + Session["user"].ToString() +
                           " ','" + DateTime.Now + "','true')";
            con.Open();
        ...
        {
            int k = 1;
            query = " update tbl_producttype set empCat_nam = '" + TBCategoryType.Text + "', CreateBy='" + Session["user"].ToString() + "', CreatedAt='" + DateTime.Now + "' where  ProductTypeID='" + HFCategory.Value + "'";
        ...
        protected void BtnCreateEmpCategoryClick(object sender, EventArgs e)
        {
            int o;
        ...
        protected void BtnCancelEmpCategoryClick(object sender, EventArgs e)
        {
            clear();
        }

        protected void GVEmpCategoryPageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            GVCategory.PageIndex = e.NewPageIndex;
            FillGrid();
        }

        protected void GVEmpCategoryRowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
