<%@ Page Title="Branches" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="Branches.aspx.cs" Inherits="Foods.Branches" %>
...
<%--    <asp:UpdatePanel  ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
            ...
            <ul class="breadcrumb">
				...
				<li><a href="Branches.aspx">Category</a></li>
			</ul>
					...
					<div class="box-content">
                        ...
                        <div class="row-fluid sortable">		
	                         <div class="box span12">
				                ...
				                <div class="box-content">
                                    <asp:GridView ID="GVCategory" runat="server" AutoGenerateColumns="False" AllowPaging="true" PageSize="5" DataKeyNames="ProductTypeID" CssClass="table table-striped table-bordered" OnRowCommand="GVBranchesRowCommand" OnPageIndexChanging="GVBranchesPageIndexChanging" OnRowDeleting="GVBranchesRowDeleting">
                                        <Columns>
				...
				<div class="modal-content">
				  ...
				  <!-- dialog buttons -->
					<div class="modal-footer">
                            <asp:Button ID="BtnCreateCategory" runat="server" CssClass="btn btn-success" Text="Create" OnClick="BtnCreateBranchesClick" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="BtnCancelCategory" runat="server" CssClass="btn btn-danger" Text="Cancel"  OnClick="BtnCancelBranchesClick" OnClientClick="show();" />
