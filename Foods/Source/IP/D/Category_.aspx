<%@ Page Title="Category Type" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="Category_.aspx.cs" Inherits="Foods.Category_" %>
...
<%--    <asp:UpdatePanel  ID="UpdatePanel1" runat="server">
        <ContentTemplate>  
            ...
            <ul class="breadcrumb">
				...
				<li><a href="Category_.aspx">Category</a></li>
			</ul>
				...
				<div class="modal-content">
                    ...
                    <tr>
                        ...
                        <td class="span8">
                            ...
                            <asp:Label ID="v_category" runat="server" Font-Bold="true" ForeColor="Red" Text=""></asp:Label>
                        </td>
                    </tr>
                </table>
					</div>
				  <!-- dialog buttons -->
					<div class="modal-footer">
                            <asp:Button ID="BtnCreateCategory" runat="server" CssClass="btn btn-success" Text="Create" OnClick="BtnCreateCategory_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
