<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt_CashTrans.aspx.cs" Inherits="Foods.rpt_CashTrans" %>
    ...
    <form id="form1" runat="server">
        <div id="Container">
	        ...
	        <div class="content">
		        ...
		        <br/>
		        <div id="Main">
                <asp:GridView ID="GVCashTrans" runat="server" AutoGenerateColumns="false" style="text-align:center;" EmptyDataText="NO Record Found" ShowHeader="true" ShowHeaderWhenEmpty="true" >
                    <Columns>                    
