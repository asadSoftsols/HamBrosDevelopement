<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt_usrwissal.aspx.cs" Inherits="Foods.rpt_usrwissal" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>User Wise Sales Reports</title>
...
<body>
    ...
    <div>
        <div id="container">
            <div class="uppper">
                <h1>Ham Brorhers</h1>
                <h2>Sales Report User Wise</h2>
            </div>
            <div class="left">
                Employee Name: <asp:Label ID="lbl_usr" runat="server" ></asp:Label><br />
            </div>
            <div class="right">
            ...
            <div class="clear"></div>
                <fieldset>
                    ...
                    <br />
                    <div class="gv">
                        <asp:GridView ID="GV_UsrWis" runat="server" EmptyDataText="No Record Found!" ShowHeader="true" AutoGenerateColumns="False" style="width:100%; height:auto;">
                            <Columns>
