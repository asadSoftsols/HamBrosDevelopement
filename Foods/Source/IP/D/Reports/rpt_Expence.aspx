<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt_Expence.aspx.cs" Inherits="Foods.rpt_Expence" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Expence Sheet</title>
    <style type="text/css">
	    body{
...
<body>
    ...
    <div>
	            ...
	            <div class="content">
		            ...
		            <br/>
		            <div id="Main">
                        <asp:GridView ID="GVProf" runat="server" ShowHeader="true" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found.." AutoGenerateColumns="False" CssClass="grid" DataKeyNames="accno" >
                            <Columns>
                                <asp:TemplateField HeaderText="Date">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_dat" runat="server" Text='<%# Eval("expensesdate")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Amount">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_amt" runat="server" Text='<%# Eval("balance")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Remarks">
                                    <ItemTemplate>
                                        <asp:Label ID="lbl_rmks" runat="server" Text='<%# Eval("expencermk")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
