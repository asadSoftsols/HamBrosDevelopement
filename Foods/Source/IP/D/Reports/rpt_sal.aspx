<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rpt_sal.aspx.cs" Inherits="Foods.rpt_sal" %>
    ...
    <div id="container">
            ...
            <div class="clear"></div>
                <fieldset>
                    ...
                    <br />
                    <div class="gv">
                        <asp:GridView ID="GV_SAL" runat="server" EmptyDataText="No Record Found!" ShowHeader="true" AutoGenerateColumns="False" style="width:100%; height:auto;" DataKeyNames="MSal_id,DSal_id" >
                            <Columns>
