...
{
    public partial class frm_VDSR_ : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //pnl_areacustsalman.Visible = false;
        ...
        private void SetInitRow()
        {
            ...
            dt.Columns.Add(new DataColumn("FINALQTY", typeof(string)));
            ...
            if (ViewState["dt_adItm"] != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 1; i <= dt.Rows.Count; i++)
                    {
                        ...
                        TextBox lbSalRtrn = (TextBox)GVPro1.Rows[rowIndex].Cells[5].FindControl("lbSalRtrn");
                        TextBox txtfinlqty = (TextBox)GVPro1.Rows[rowIndex].Cells[6].FindControl("txtfinlqty");
                        Label LBRecy = (Label)GVPro1.Rows[rowIndex].Cells[7].FindControl("LBRecy");
                        Label lbOutstan = (Label)GVPro1.Rows[rowIndex].Cells[8].FindControl("lbOutstan");
                        Label lblfurOutstan = (Label)GVPro1.Rows[rowIndex].Cells[9].FindControl("lblfurOutstan");
                        TextBox TBAmt = (TextBox)GVPro1.Rows[rowIndex].Cells[10].FindControl("TBAmt");
                        TextBox TBRmk = (TextBox)GVPro1.Rows[rowIndex].Cells[11].FindControl("TBRmk");
                        //TextBox lblttl = (TextBox)GVPro1.Rows[rowIndex].Cells[8].FindControl("lblttl");
                        Label dsrid = (Label)GVPro1.FooterRow.Cells[12].FindControl("HFDSR");
                        ...
                        dt.Rows[i - 1]["FINALQTY"] = txtfinlqty.Text;
                ...
                if (ViewState["dt_adItm"] != null)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        for (int i = 0; i < dt.Rows.Count; i++)
                        {
                            ...
                            txtfinlqty.Text = dt.Rows[i]["FINALQTY"].ToString();
                            ...
                            string finalqty = dt.Rows[i]["FINALQTY"].ToString();
        ...
        private void Update()
        {
            ...
            try
            {
                ...
                command.CommandText =
                    ...
                    "', furout=" + tbfurOutstan.Text.Trim() + ", prevbal = '" + lblOutstan.Text + "', CreateAt = '"
                    + DateTime.Today.ToString("MM/dd/yyyy", CultureInfo.InvariantCulture) +
                    "', CompanyId = '" + Session["CompanyID"] + "', BranchId ='" + Session["BranchID"]
                    + "' where dsrid='" + HFdsrID.Value.Trim()
                    + "' and CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "' and saleper='" + lbl_disc.Text + "'";
                    //"' and prevbal = '" + lblOutstan.Text + "'";
                ...
                foreach (GridViewRow g1 in GVPro1.Rows)
                {
                    ...
                    string lbSalRtrn = (g1.FindControl("lbSalRtrn") as TextBox).Text;
                    string txtfinlqty = (g1.FindControl("txtfinlqty") as TextBox).Text;                    
                    ...
                    if (HFDSR != "")
                    {
                        command.CommandText =
                            ...
                            TBQty + "', salrat='" + TBSalRat + "', salrturn ='" + lbSalRtrn.Trim() + "', finlqry='" + txtfinlqty + "', recvry='" +
                    ...
                    {
                        command.CommandText =
                       " INSERT INTO tbl_ddsr (dsrid, ProductTypeID, ProductID, untid, Qty, salrat, salrturn, finlqry,  recvry, " +
                       "  outstan, Amt,  ttlamt, dsrrmk, CompanyId, BranchId, CreateAt, CreateBy) " +
                       " VALUES " +
                       " ('" + HFdsrID.Value.Trim() + "', '', '" + proid + "','" + DDL_Unt + "','" + TBQty + "','" +
                       TBSalRat + "','" + lbSalRtrn + "','" + txtfinlqty + "', '" + TBRecy.Text.Trim() + "','" + lblOutstan.Text + "','" 
                ...
                command.CommandText = " update tbl_Mdsr set updateBy='" + Session["user"] + "' where dsrid='" + HFdsrID.Value.Trim() + "'";
            ...
            finally
            {
                ...
                //FillGrid();
                //ptnSno();
                Response.Redirect("frm_VDSR_.aspx");
                //BindDll();
            }
        ...
        private int Save()
        {
            ...
            try
            {
                ...
                command.Parameters.Clear();
                command.CommandText = " update tbl_Mdsr set updateBy='" + Session["user"] + "' where dsrid='" + mdsrId + "'";
                command.CommandType = CommandType.Text;
        ...
        public void BindDLL()
        {
            ...
            dt_ = new DataTable();
            dt_ = DBConnection.GetQueryData("select rtrim('[' + CAST(CustomerID AS VARCHAR(200)) + ']-' + CustomerName ) as [CustomerName], cust_acc from Customers_ where CompanyId = '" + Session["CompanyID"] + "' and BranchId= '" + Session["BranchID"] + "'");
        ...
        protected void lbSalRtrn_TextChanged(object sender, EventArgs e)
        {
            try
            {
                string saleper = "";
                ...
                for (int j = 0; j < GVPro1.Rows.Count; j++)
                {
                    ...
                    TextBox lbSalRtrn = (TextBox)GVPro1.Rows[i].FindControl("lbSalRtrn");
                    TextBox txtfinlqty = (TextBox)GVPro1.Rows[i].FindControl("txtfinlqty");

                    // Putting Data in Final Quantity...

                    txtfinlqty.Text = (Convert.ToDecimal(TBQty.Text) - Convert.ToDecimal(lbSalRtrn.Text)).ToString();
                    ...
                    if (dt_.Rows.Count > 0)
                    {
                        ...
                        if (chkqty < Convert.ToDecimal(txtfinlqty.Text.Trim()))
                        {
                    ...
                    TBAmt.Text = (Convert.ToDouble(txtfinlqty.Text.Trim()) * Convert.ToDouble(TbSalRat.Text.Trim())).ToString();
                }
