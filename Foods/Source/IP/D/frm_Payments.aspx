<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frm_Payments.aspx.cs" Inherits="Foods.frm_Payments" %>
			            ...
			            <div class="row-fluid sortable">
				            <div class="box span12">
					            ...
					            <div class="box-content">
							        ...
							        <fieldset>
                                        <div class="scrollit">
                                            <asp:GridView ID="GVSrchCust" ShowHeader="true" CssClass="table table-striped table-bordered" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="BillNO" runat="server"  OnRowCancelingEdit="GVSrchCust_RowCancelingEdit" OnRowEditing="GVSrchCust_RowEditing" OnRowUpdating="GVSrchCust_RowUpdating">
                                                <Columns>
                                                    <asp:TemplateField>  
                                                        <ItemTemplate>  
                                                            <asp:Button ID="btn_Edit" runat="server" Text="Change" CommandName="Edit" />  
                                                        </ItemTemplate>  
                                                        <EditItemTemplate>  
                                                    ...
                                                    <asp:BoundField DataField="CellNo1" HeaderText="MOBILE NUMBER"  SortExpression="CellNo1" ReadOnly="true" />                                                    
                                                    <asp:TemplateField HeaderText="ADVANCE">  
                                                        <ItemTemplate>  
                                                            <asp:Label ID="lbl_Adv" runat="server" Text='<%#Eval("adv") %>'></asp:Label>  
                                                        </ItemTemplate>  
                                                        <EditItemTemplate>
                                                            <asp:Label ID="lbl_ID" runat="server" Text='<%#Eval("Mposid") %>' Visible="false"></asp:Label>
                                                            <asp:TextBox ID="txt_Adv" runat="server" Text='<%#Eval("adv") %>' AutoPostBack="true" OnTextChanged="txt_Adv_TextChanged"></asp:TextBox>  
                                                        </EditItemTemplate>  
                                                    </asp:TemplateField>  
                                                    <asp:TemplateField HeaderText="BALANCE">  
                                                        <ItemTemplate>  
                                                            <asp:Label ID="lbl_bal" runat="server" Text='<%#Eval("bal") %>'></asp:Label>  
                                                        </ItemTemplate>  
                                                        <EditItemTemplate>  
                                                            <asp:TextBox ID="txt_bal" runat="server" Text='<%#Eval("bal") %>'></asp:TextBox>  
                                                        </EditItemTemplate>  
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="TOTAL">  
                                                        <ItemTemplate>  
                                                            <asp:Label ID="lbl_ttl" runat="server" Text='<%#Eval("grntttl") %>'></asp:Label>  
                                                        </ItemTemplate>  
                                                        <EditItemTemplate>  
                                                            <asp:Label ID="lbl_ettl" runat="server" Text='<%#Eval("grntttl") %>'></asp:Label>  
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField DataField="billdat" HeaderText="BILL DATE" SortExpression="billdat" ReadOnly="true" />                                                                                    
                                                    <asp:BoundField DataField="billtim" HeaderText="BILL TIME"  SortExpression="billtim"  ReadOnly="true" />                                                   
                                                    <asp:BoundField DataField="createdby" HeaderText="CREATED BY" SortExpression="createdby" ReadOnly="true" />                                                                                    
                                                    <asp:BoundField DataField="createdat" HeaderText="CREATED AT" SortExpression="createdat" ReadOnly="true" />                                                                                                                                          
                                                </Columns>
